...
//     if (timerStarted) {
//       uint32_t elapsed = (xTaskGetTickCount() - tStart) * portTICK_PERIOD_MS;
//       Serial.printf("[HeaterMixer] Suhu=%.2fC, Elapsed=%lus\n", tC, elapsed / 1000);
...
BLYNK_WRITE(STATUS) {
  ...
  //   Blynk.virtualWrite(PENGERAS_LED, 1);   // LED Pengeras di Blynk nyala
  // } else {
  //   Blynk.virtualWrite(PENGERAS_LED, 0);   // LED Pengeras di Blynk mati
  // }
}
...
void sendToBlynk() {
  ...
  // } else if (statusMode == "OIL SOLIDIFIER") {
  //   Blynk.virtualWrite(SERVO_LED, 0);
  //   Blynk.virtualWrite(PENGERAS_LED, 1);
  // } else {
  //   Blynk.virtualWrite(SERVO_LED, 0);
  //   Blynk.virtualWrite(PENGERAS_LED, 0);
